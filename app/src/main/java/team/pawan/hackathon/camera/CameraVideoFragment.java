package team.pawan.hackathon.camera;
...
import team.pawan.hackathon.MetaEmbed;
import team.pawan.hackathon.R;
import team.pawan.hackathon.SerializeObject;
import team.pawan.hackathon.TrackingService;
import team.pawan.hackathon.ui.base.BaseFragment;
...
//        trackingService.isStop = true;
        getActivity().stopService(new Intent(getActivity(), TrackingService.class));
        mMediaRecorder.stop();
        mMediaRecorder.reset();
        MetaEmbed metaEmbed = new MetaEmbed(getContext(), new File("/storage/emulated/Code Knight/datapoints.txt"), mCurrentFile);
        String metadata = metaEmbed.printData();
        //decode StringtoObject
        Toast.makeText(getActivity(), metadata, Toast.LENGTH_SHORT).show();
    }
